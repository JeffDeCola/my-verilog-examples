...
echo "'iverilog -o not1_tb.vvp not1_tb.v not1.vh'"
...
echo "'vpp not1_tb.vvp'"
vvp not1_tb.vvp
echo " "

echo "Now you can open the waveform file not1_tb.vcd with GTKWave."
echo "gtkwave -f not1_tb.vcd &"
echo " "

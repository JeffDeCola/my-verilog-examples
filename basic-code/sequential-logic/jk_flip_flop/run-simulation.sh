...
echo "'iverilog -o jk_flip_flop_tb.vvp jk_flip_flop_tb.v jk_flip_flop.vh'"
...
echo "'vpp jk_flip_flop_tb.vvp'"
vvp jk_flip_flop_tb.vvp
echo " "

echo "Now you can open the waveform file jk_flip_flop_tb.vcd with GTKWave."
echo "gtkwave -f jk_flip_flop_tb.vcd &"
echo " "

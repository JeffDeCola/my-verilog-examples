...
echo "'iverilog -o full_adder_tb.vvp full_adder_tb.v full_adder.vh'"
...
echo "'vpp full_adder_tb.vvp'"
vvp full_adder_tb.vvp
echo " "

echo "Now you can open the waveform file full_adder_tb.vcd with GTKWave."
echo "gtkwave -f full_adder_tb.vcd &"
echo " "

...
echo "'iverilog -o jeff_74x157_tb.vvp jeff_74x157_tb.v jeff_74x157.vh'"
...
echo "'vpp jeff_74x157_tb.vvp'"
vvp jeff_74x157_tb.vvp
echo " "

echo "Now you can open the waveform file jeff_74x157_tb.vcd with GTKWave."
echo "gtkwave -f jeff_74x157_tb.vcd &"
echo " "

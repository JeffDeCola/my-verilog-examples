...
echo "'iverilog -o jeff-74x151-tb.vvp jeff-74x151-tb.v jeff-74x151-headerfiles.vh'"
iverilog -o jeff-74x151-tb.vvp jeff-74x151-tb.v jeff-74x151-headerfiles.vh
echo " "

echo "Now we run simulation to create the waveform file *.vcd."
echo " "

echo "'./jeff-74x151-tb.vvp'"
./jeff-74x151-tb.vvp
echo " "

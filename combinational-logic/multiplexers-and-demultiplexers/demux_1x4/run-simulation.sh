...
echo "'iverilog -o demux_1x4_tb.vvp demux_1x4_tb.v demux_1x4.vh'"
...
echo "'vpp demux_1x4_tb.vvp'"
vvp demux_1x4_tb.vvp
echo " "

echo "Now you can open the waveform file demux_1x4_tb.vcd with GTKWave."
echo "gtkwave -f demux_1x4_tb.vcd &"
echo " "

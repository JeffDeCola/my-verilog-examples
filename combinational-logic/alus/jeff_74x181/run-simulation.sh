...
echo "'iverilog -o jeff_74x181_tb.vvp jeff_74x181_tb.v jeff_74x181.vh'"
...
echo "'vpp jeff_74x181_tb.vvp'"
vvp jeff_74x181_tb.vvp
echo " "

echo "Now you can open the waveform file jeff_74x181_tb.vcd with GTKWave."
echo "gtkwave -f jeff_74x181_tb.vcd &"
echo " "

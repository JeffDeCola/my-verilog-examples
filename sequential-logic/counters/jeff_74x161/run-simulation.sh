...
echo "'iverilog -o jeff_74x161_tb.vvp jeff_74x161_tb.v jeff_74x161.vh'"
...
echo "'vpp jeff_74x161_tb.vvp'"
vvp jeff_74x161_tb.vvp
echo " "

echo "Now you can open the waveform file jeff_74x161_tb.vcd with GTKWave."
echo "gtkwave -f jeff_74x161_tb.vcd &"
echo " "

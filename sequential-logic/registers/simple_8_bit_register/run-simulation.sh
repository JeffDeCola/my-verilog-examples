...
echo "'iverilog -o simple_8_bit_register_tb.vvp simple_8_bit_register_tb.v simple_8_bit_register.vh'"
...
echo "'vpp simple_8_bit_register_tb.vvp'"
vvp simple_8_bit_register_tb.vvp
echo " "

echo "Now you can open the waveform file simple_8_bit_register_tb.vcd with GTKWave."
echo "gtkwave -f simple_8_bit_register_tb.vcd &"
echo " "

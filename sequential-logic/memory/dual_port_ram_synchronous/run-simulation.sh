...
echo "'iverilog -o dual_port_ram_synchronous_tb.vvp dual_port_ram_synchronous_tb.v dual_port_ram_synchronous.vh'"
...
echo "'vpp dual_port_ram_synchronous_tb.vvp'"
vvp dual_port_ram_synchronous_tb.vvp
echo " "

echo "Now you can open the waveform file dual_port_ram_synchronous_tb.vcd with GTKWave."
echo "gtkwave -f dual_port_ram_synchronous_tb.vcd &"
echo " "
